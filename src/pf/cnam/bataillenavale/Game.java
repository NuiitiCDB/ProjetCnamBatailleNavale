...
public class Game {
    ...
    /**
     * Affiche le nom du vainqueur et les statistiques du match
     * 
     * @return void
     */
    public void end() {
    ...
    /**
     * Définit le type de l’adversaire
     * 
     * @return String
     */
    ...
    /**
     * Définit aléatoirement l’ordre de jeu entre les deux joueurs
     *
     * @return void
     */
    ...
    private void printGameLauncher() {
        ...
        System.out.println(" .----------------.  .-----------------. .----------------.  .----------------.        ");
        System.out.println("| .--------------. || .--------------. || .--------------. || .--------------. |       ");
        System.out.println("| |     ______   | || | ____  _____  | || |      __      | || | ____    ____ | |       ");
        System.out.println("| |   .' ___  |  | || ||_   \\|_   _| | || |     /  \\     | || ||_   \\  /   _|| |    ");
        System.out.println("| |  / .'   \\_|  | || |  |   \\ | |   | || |    / /\\ \\    | || |  |   \\/   |  | |  ");
        System.out.println("| |  | |         | || |  | |\\ \\| |   | || |   / ____ \\   | || |  | |\\  /| |  | |   ");
        System.out.println("| |  \\ `.___.'\\  | || | _| |_\\   |_  | || | _/ /    \\ \\_ | || | _| |_\\/_| |_ | |");
        System.out.println("| |   `._____.'  | || ||_____|\\____| | || ||____|  |____|| || ||_____||_____|| |      ");
        System.out.println("| |              | || |              | || |              | || |              | |       ");
        System.out.println("| '--------------' || '--------------' || '--------------' || '--------------' |       ");
        System.out.println(" '----------------'  '----------------'  '----------------'  '----------------'        ");
        System.out.println();
